...
import {
  ...
  PlotSplineDataLabelsOptions,
  PlotSplineDataSortingOptions, PointMarkerOptionsObject, PointOptionsObject,
  ...
  SeriesSplineOptions, SeriesStatesOptionsObject, SeriesTooltipOptionsObject, SeriesZonesOptionsObject, ShadowOptionsObject
} from 'highcharts';
